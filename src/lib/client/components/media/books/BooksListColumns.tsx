...
export const getBooksColumns = (props: ColumnConfigProps): ColumnDef<typeof mediaTableFeatures, ExtractListByType<typeof MediaType.BOOKS>>[] => {
    const base = getBaseColumns<ExtractListByType<typeof MediaType.BOOKS>>(props);
