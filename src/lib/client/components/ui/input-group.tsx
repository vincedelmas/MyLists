    ...
    return (
        <div
            ...
            className={cn("group/input-group relative flex h-8 w-full min-w-0 items-center rounded-lg border border-input " +
                ...
                "has-[[data-slot=input-group-control]:focus-visible]:border-ring has-[[data-slot=input-group-control]:focus-visible]:ring-1 " +
                "has-[[data-slot=input-group-control]:focus-visible]:ring-ring/50 has-[[data-slot=select-trigger]:focus-visible]:border-ring " +
                "has-[[data-slot=select-trigger]:focus-visible]:ring-1 has-[[data-slot=select-trigger]:focus-visible]:ring-ring/50 " +
...
const inputGroupAddonVariants = cva("flex h-auto cursor-text items-center justify-center gap-2 py-1.5 text-sm font-medium " +
    "text-muted-foreground select-none group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-[calc(var(--radius)-5px)] " +
    ...
    return (
        <div
            ...
            onClick={(ev) => {
                ...
                ev.currentTarget.parentElement?.querySelector("input")?.focus();
            }}
            {...props}
        />
    )
...
function InputGroupText({ className, ...props }: React.ComponentProps<"span">) {
    return (
        <span
            className={cn("flex items-center gap-2 text-sm text-muted-foreground [&_svg]:pointer-events-none " +
...
function InputGroupInput({ className, ...props }: React.ComponentProps<"input">) {
    return (
        <Input
            ...
            className={cn("flex-1 rounded-none border-0 bg-transparent shadow-none ring-0 focus-visible:ring-0 " +
...
function InputGroupTextarea({ className, ...props }: React.ComponentProps<"textarea">) {
    return (
        <Textarea
            data-slot="input-group-control"
            className={cn("flex-1 resize-none rounded-none border-0 bg-transparent py-2 shadow-none ring-0 " +
