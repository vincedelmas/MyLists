    ...
    return (
        <ToastPrimitive.Root
            ...
            className={cn(
                ...
                "origin-bottom rounded-2xl border bg-popover text-popover-foreground shadow-lg will-change-transform " +
                "outline-none select-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50",
...
function ToastContent({ className, ...props }: ToastPrimitive.Content.Props) {
    return (
        <ToastPrimitive.Content
            ...
            className={cn(
                "flex h-full items-center gap-3 overflow-hidden p-3 transition-opacity duration-250 " +
