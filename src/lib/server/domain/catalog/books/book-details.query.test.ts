...
const { BookLibraryCommands } = await import("@/lib/server/domain/library/books/book-library.commands");
...
const { BookLibraryReadRepository } = await import("@/lib/server/domain/library/books/book-library-read.repository");
