...
import type {BaseService} from "@/lib/server/domain/media/base/base.service";
...
export const internalApiIdMatcher = (apiProviderType: ApiProviderType, mediaService: Pick<BaseService, "findByApiIds">): InternalMediaMatcher => ({
