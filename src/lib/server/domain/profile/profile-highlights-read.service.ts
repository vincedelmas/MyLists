...
export class ProfileHighlightsReadService {
    constructor(
    ...
    private resolveSettingsDefaults(settings?: HighlightedMediaSettings): HighlightedMediaSettings {
        ...
        return Object.entries(defaults).reduce((resolved, [tab]) => {
            ...
            resolved[typedTab] = {
                ...
                items: (saved?.items || [])
                    .filter((item) => typedTab === "overview" || item.mediaType === typedTab)
