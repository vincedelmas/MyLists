...
const { SocialGraphReadService } = await import("../social/social-graph-read.service");
const { ProfileReadService } = await import("./profile-read.service");


describe("profile read service", () => {
    let sqlite: Database;
    let db: ReturnType<typeof drizzle<typeof schema>>;
    let service: InstanceType<typeof ProfileReadService>;
