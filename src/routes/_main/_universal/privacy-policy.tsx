...
function PrivacyPolicyPage() {
    return (
        <PageTitle title="Privacy Policy" onlyHelmet>
            <div className="mb-12 flex flex-col pt-8">
                <PageHeader
                    title="Privacy policy"
                    eyebrowIcon={FileText}
                    asideIcon={ShieldCheck}
                    eyebrow="About your data"
                    asideLabel="This page explains"
                    asideValue="How your data is handled"
                    description="What MyLists stores, what it is used for and how it is protected."
                />
                <article className="mt-4 space-y-4 rounded-xl text-sm leading-relaxed text-muted-foreground shadow-xs
                [&_a]:text-brand [&_h5]:text-foreground [&_strong]:text-foreground">
                    <p className="mt-2">
